...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-o5g5hpy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-o5g5hpy.containers.anotherwebservice.com/
...
```
git clone git@github.com:flash-of-genius/container-o5g5hpy.git
cd container-o5g5hpy
```
...
```
docker attach container-o5g5hpy
```
